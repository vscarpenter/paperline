...
var PLButton = ({
  ...
  return /* @__PURE__ */ jsxs2(
    "button",
    {
      ...
      ...rest,
      children: [
        IconComp && /* @__PURE__ */ jsx2(IconComp, { size: s.ic }),
        children,
...
var PLInput = ({ icon: IconComp, suffix, placeholder, value, onChange, type = "text", error, id, disabled, ...rest }) => /* @__PURE__ */ jsxs2("label", { className: "pl-field", style: {
  display: "flex",
  alignItems: "center",
  gap: 8,
  padding: "9px 12px",
  ...
  IconComp && /* @__PURE__ */ jsx2(IconComp, { size: 15, style: { color: "var(--pl-ink-4)", flexShrink: 0 } }),
  /* @__PURE__ */ jsx2(
    "input",
    {
      id,
...
var PLTextarea = ({ placeholder, value, onChange, rows = 3, error, id, disabled, ...rest }) => /* @__PURE__ */ jsx2(
  "textarea",
  {
    id,
    rows,
...
var PLSelect = ({ value, onChange, options = [], placeholder, id, disabled, error, ...rest }) => /* @__PURE__ */ jsxs2("div", { className: "pl-field", style: {
  display: "flex",
  alignItems: "center",
  gap: 6,
  ...
  /* @__PURE__ */ jsxs2(
    "select",
    {
      ...
      children: [
        ...
        options.map((o) => typeof o === "string" ? /* @__PURE__ */ jsx2("option", { value: o, children: o }, o) : /* @__PURE__ */ jsx2("option", { value: o.value, disabled: o.disabled, children: o.label }, o.value))
      ]
    }
  ),
  /* @__PURE__ */ jsx2(I.ChevDown, { size: 14, style: { color: "var(--pl-ink-4)" } })
] });
var PLToggle = ({ checked, onChange, label, disabled, id, name }) => {
  const auto = useId();
  const inputId = id || auto;
  return /* @__PURE__ */ jsxs2("label", { htmlFor: inputId, className: "pl-toggle", style: {
    display: "inline-flex",
    alignItems: "center",
    gap: 10,
    cursor: disabled ? "not-allowed" : "pointer",
    ...
    /* @__PURE__ */ jsx2("span", { "aria-hidden": "true", className: "pl-toggle-track", style: {
      position: "relative",
      width: 32,
      height: 18,
...
var PLCheckbox = ({ checked, onChange, label, indeterminate, disabled, id, name, value }) => {
  ...
  return /* @__PURE__ */ jsxs2("label", { htmlFor: inputId, className: "pl-checkbox", style: {
    display: "inline-flex",
    alignItems: "center",
    gap: 10,
    cursor: disabled ? "not-allowed" : "pointer",
    ...
    /* @__PURE__ */ jsxs2("span", { "aria-hidden": "true", className: "pl-checkbox-box", style: {
      width: 16,
      height: 16,
      ...
      checked && !indeterminate && /* @__PURE__ */ jsx2(I.Check, { size: 11, strokeWidth: 2.4, style: { color: "var(--pl-accent-ink)" } }),
      indeterminate && /* @__PURE__ */ jsx2("span", { style: { width: 8, height: 1.6, background: "var(--pl-accent-ink)" } })
    ] }),
    label
  ] });
};
var PLRadio = ({ checked, onChange, label, disabled, id, name, value }) => {
  const auto = useId();
  const inputId = id || auto;
  return /* @__PURE__ */ jsxs2("label", { htmlFor: inputId, className: "pl-radio", style: {
    display: "inline-flex",
    alignItems: "center",
    gap: 10,
    cursor: disabled ? "not-allowed" : "pointer",
    ...
    /* @__PURE__ */ jsx2("span", { "aria-hidden": "true", className: "pl-radio-dot", style: {
      width: 16,
      height: 16,
      borderRadius: 999,
      background: "var(--pl-paper-card)",
      ...
      justifyContent: "center",
      flexShrink: 0
    }, children: checked && /* @__PURE__ */ jsx2("span", { style: { width: 8, height: 8, borderRadius: 999, background: "var(--pl-accent-500)" } }) }),
    label
  ] });
};
var PLField = ({ label, helper, error, required, children, id }) => {
  ...
  return /* @__PURE__ */ jsxs2("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
    label && /* @__PURE__ */ jsxs2("label", { htmlFor: inputId, style: {
      fontSize: 12,
      fontWeight: 600,
      color: "var(--pl-ink-2)",
      fontFamily: "var(--pl-font-sans)"
      ...
      label,
      required && /* @__PURE__ */ jsx2("span", { "aria-hidden": "true", style: { color: "var(--pl-danger-500)", marginLeft: 3 }, children: "*" })
    ] }),
    cloned,
    helper && !error && /* @__PURE__ */ jsx2("div", { id: helperId, style: { fontSize: 11.5, color: "var(--pl-ink-3)" }, children: helper }),
    error && /* @__PURE__ */ jsx2("div", { id: errorId, style: { fontSize: 11.5, color: "var(--pl-danger-500)" }, children: error })
  ] });
};
var PLBadge = ({ tone = "neutral", children, dot }) => {
  ...
  return /* @__PURE__ */ jsxs2("span", { style: {
    ...
    dot && /* @__PURE__ */ jsx2("span", { "aria-hidden": "true", style: { width: 6, height: 6, borderRadius: 999, background: t.d } }),
    children
  ] });
};
var PLTag = ({ children, onRemove }) => /* @__PURE__ */ jsxs2("span", { style: {
  display: "inline-flex",
  alignItems: "center",
  gap: 4,
  padding: "2px 7px",
  ...
  onRemove && /* @__PURE__ */ jsx2(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx2(I.X, { size: 11 })
    }
  )
] });
var PLCard = ({ children, padding = 20, lifted, ...rest }) => /* @__PURE__ */ jsx2("div", { style: {
  background: "var(--pl-paper-card)",
  border: "1px solid var(--pl-hairline)",
  borderRadius: 12,
  padding,
...
var PLDivider = ({ orientation = "horizontal", label }) => {
  ...
  if (label) {
    return /* @__PURE__ */ jsxs2("div", { role: "separator", "aria-orientation": "horizontal", style: {
      display: "flex",
      alignItems: "center",
      gap: 10,
      color: "var(--pl-ink-4)"
    }, children: [
      /* @__PURE__ */ jsx2("span", { style: { flex: 1, height: 1, background: "var(--pl-hairline-strong)" } }),
      /* @__PURE__ */ jsx2("span", { style: { fontSize: 11, fontWeight: 600, letterSpacing: 0.08, textTransform: "uppercase" }, children: label }),
      /* @__PURE__ */ jsx2("span", { style: { flex: 1, height: 1, background: "var(--pl-hairline-strong)" } })
    ] });
  }
  return /* @__PURE__ */ jsx2("hr", { role: "separator", style: { border: "none", height: 1, background: "var(--pl-hairline-strong)", margin: 0 } });
};
var initials = (name) => (name || "").trim().split(/\s+/).slice(0, 2).map((s) => s[0]?.toUpperCase() || "").join("");
var PLAvatar = ({ name, size = 32, src, color = "var(--pl-cat-plum)", alt }) => /* @__PURE__ */ jsx2("span", { style: {
  display: "inline-flex",
  alignItems: "center",
  justifyContent: "center",
  width: size,
  ...
  overflow: "hidden",
  flexShrink: 0
}, children: src ? /* @__PURE__ */ jsx2("img", { src, alt: alt ?? name ?? "", style: { width: "100%", height: "100%", objectFit: "cover" } }) : /* @__PURE__ */ jsx2("span", { "aria-hidden": !alt && !name, children: initials(name) }) });
var PLAvatarGroup = ({ people, max = 3 }) => {
  const shown = people.slice(0, max);
  const extra = people.length - max;
  return /* @__PURE__ */ jsxs2("div", { style: { display: "inline-flex" }, children: [
    shown.map((p, i) => /* @__PURE__ */ jsx2("div", { style: { marginLeft: i ? -8 : 0, border: "2px solid var(--pl-paper-card)", borderRadius: 999 }, children: /* @__PURE__ */ jsx2(PLAvatar, { name: p.name, color: p.color, src: p.src, size: 28 }) }, i)),
    extra > 0 && /* @__PURE__ */ jsxs2("span", { style: {
      marginLeft: -8,
      width: 28,
      height: 28,
      borderRadius: 999,
...
var PLProgress = ({ value = 0, label, accent = "var(--pl-accent-500)" }) => {
  ...
  return /* @__PURE__ */ jsxs2("div", { children: [
    label && /* @__PURE__ */ jsxs2("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 11, color: "var(--pl-ink-3)", marginBottom: 6 }, children: [
      /* @__PURE__ */ jsx2("span", { style: { fontWeight: 500 }, children: label }),
      /* @__PURE__ */ jsxs2("span", { className: "pl-mono", style: { fontWeight: 600, color: "var(--pl-ink-2)" }, children: [
        v,
        "%"
      ] })
    ] }),
...
var PLSpinner = ({ size = 16, label = "Loading" }) => /* @__PURE__ */ jsxs2("span", { role: "status", "aria-label": label, style: { display: "inline-flex", color: "var(--pl-accent-500)" }, children: [
  /* @__PURE__ */ jsxs2(
    "svg",
    {
      width: size,
      ...
      "aria-hidden": "true",
      children: [
        /* @__PURE__ */ jsx2("circle", { cx: "12", cy: "12", r: "9", stroke: "currentColor", strokeOpacity: "0.2", strokeWidth: "2.4" }),
        /* @__PURE__ */ jsx2("path", { d: "M21 12a9 9 0 0 0-9-9", stroke: "currentColor", strokeWidth: "2.4", strokeLinecap: "round" })
      ]
    }
  ),
  /* @__PURE__ */ jsx2("span", { className: "pl-sr-only", children: label })
] });
var PLSkeleton = ({ width = "100%", height = 12, radius = 4, style }) => /* @__PURE__ */ jsx2("span", { "aria-hidden": "true", style: {
  display: "block",
  width,
  height,
  borderRadius: radius,
...
var PLAlert = ({ tone = "info", title, children, icon: IconComp }) => {
  ...
  return /* @__PURE__ */ jsxs2("div", { role, style: {
    display: "flex",
    gap: 12,
    padding: "12px 14px",
    background: t.bg,
    ...
    /* @__PURE__ */ jsx2(Use, { size: 16, style: { marginTop: 2, flexShrink: 0 } }),
    /* @__PURE__ */ jsxs2("div", { style: { flex: 1, color: "var(--pl-ink-2)" }, children: [
      title && /* @__PURE__ */ jsx2("div", { style: { fontSize: 13, fontWeight: 600, color: t.fg }, children: title }),
      /* @__PURE__ */ jsx2("div", { style: { fontSize: 12.5, lineHeight: 1.55, marginTop: title ? 2 : 0 }, children })
    ] })
  ] });
};
var PLEmptyState = ({ icon: IconComp = I.Inbox, title, description, action }) => /* @__PURE__ */ jsxs2("div", { style: {
  display: "flex",
  ...
  /* @__PURE__ */ jsx2("span", { style: {
    ...
    alignItems: "center",
    justifyContent: "center"
  }, children: /* @__PURE__ */ jsx2(IconComp, { size: 22 }) }),
  title && /* @__PURE__ */ jsx2("div", { className: "pl-serif", style: { fontSize: 18, color: "var(--pl-ink-1)" }, children: title }),
  description && /* @__PURE__ */ jsx2("div", { style: { fontSize: 12.5, color: "var(--pl-ink-3)", maxWidth: 360 }, children: description }),
  action && /* @__PURE__ */ jsx2("div", { style: { marginTop: 6 }, children: action })
] });
var PLTabs = ({ items, value, onChange, label = "Tabs" }) => {
  ...
  return /* @__PURE__ */ jsx2("div", { role: "tablist", "aria-label": label, style: {
    display: "inline-flex",
    gap: 2,
    padding: 3,
    background: "var(--pl-paper-1)",
...
var PLStat = ({ label, value, delta, tone = "neutral" }) => {
  ...
  return /* @__PURE__ */ jsxs2("div", { style: {
    ...
    /* @__PURE__ */ jsx2("div", { className: "pl-eyebrow", style: { fontSize: 10 }, children: label }),
    /* @__PURE__ */ jsxs2("div", { style: { display: "flex", alignItems: "baseline", gap: 8, marginTop: 4 }, children: [
      /* @__PURE__ */ jsx2("span", { className: "pl-serif", style: { fontSize: 28, color: tones[tone] || tones.neutral, letterSpacing: -0.02 }, children: value }),
      delta && /* @__PURE__ */ jsx2("span", { className: "pl-mono", style: { fontSize: 11, color: delta.startsWith("+") ? "var(--pl-ok-500)" : "var(--pl-danger-500)", fontWeight: 600 }, children: delta })
    ] })
  ] });
};
var PLTable = ({ columns, rows, caption }) => /* @__PURE__ */ jsx2("div", { style: {
  background: "var(--pl-paper-card)",
  border: "1px solid var(--pl-hairline-strong)",
  borderRadius: 10,
  overflow: "hidden",
  boxShadow: "var(--pl-shadow-xs)"
}, children: /* @__PURE__ */ jsxs2("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 13 }, children: [
  caption && /* @__PURE__ */ jsx2("caption", { className: "pl-sr-only", children: caption }),
  /* @__PURE__ */ jsx2("thead", { children: /* @__PURE__ */ jsx2("tr", { style: { background: "var(--pl-paper-1)", borderBottom: "1px solid var(--pl-hairline-strong)" }, children: columns.map((c) => /* @__PURE__ */ jsx2("th", { scope: "col", style: {
    textAlign: "left",
    padding: "10px 14px",
    fontSize: 10.5,
    letterSpacing: 0.14,
  ...
  /* @__PURE__ */ jsx2("tbody", { children: rows.map((r, i) => /* @__PURE__ */ jsx2("tr", { style: { borderBottom: i < rows.length - 1 ? "1px solid var(--pl-hairline)" : "none" }, children: columns.map((c) => /* @__PURE__ */ jsx2("td", { style: { padding: "12px 14px", color: "var(--pl-ink-2)" }, children: c.render ? c.render(r) : r[c.key] }, c.key)) }, i)) })
] }) });
var PLToast = ({ tone = "neutral", icon: IconComp, title, action, duration = 0, onDismiss }) => {
  ...
  return /* @__PURE__ */ jsxs2("div", { role, "aria-live": tone === "danger" ? "assertive" : "polite", style: {
    display: "inline-flex",
    alignItems: "center",
    gap: 10,
    padding: "10px 14px",
    ...
    IconComp && /* @__PURE__ */ jsx2(IconComp, { size: 15, style: { color: t.d } }),
    /* @__PURE__ */ jsx2("span", { style: { fontSize: 13, fontWeight: 500, color: t.fg }, children: title }),
...
var PLStack = ({ gap = 12, align = "stretch", as: Tag = "div", children, style, ...rest }) => /* @__PURE__ */ jsx2(Tag, { style: { display: "flex", flexDirection: "column", gap, alignItems: align, ...style }, ...rest, children });
var PLCluster = ({ gap = 8, align = "center", justify = "flex-start", wrap = true, as: Tag = "div", children, style, ...rest }) => /* @__PURE__ */ jsx2(Tag, { style: {
  display: "flex",
  flexDirection: "row",
...
var PLGrid = ({ cols = 3, gap = 16, minCol, as: Tag = "div", children, style, ...rest }) => /* @__PURE__ */ jsx2(Tag, { style: {
  display: "grid",
  gridTemplateColumns: minCol ? `repeat(auto-fill, minmax(${typeof minCol === "number" ? `${minCol}px` : minCol}, 1fr))` : `repeat(${cols}, minmax(0, 1fr))`,
  gap,
  ...style
}, ...rest, children });
var PLBreadcrumbs = ({ items }) => /* @__PURE__ */ jsx2("nav", { "aria-label": "Breadcrumb", children: /* @__PURE__ */ jsx2("ol", { style: {
  display: "flex",
  flexWrap: "wrap",
  alignItems: "center",
  gap: 6,
  ...
  return /* @__PURE__ */ jsxs2("li", { style: { display: "inline-flex", alignItems: "center", gap: 6 }, children: [
    it.href && !last ? /* @__PURE__ */ jsx2("a", { href: it.href, className: "pl-link", style: { color: "var(--pl-ink-2)", textDecoration: "none", fontWeight: 500 }, children: it.label }) : /* @__PURE__ */ jsx2("span", { "aria-current": last ? "page" : void 0, style: { color: last ? "var(--pl-ink-1)" : "var(--pl-ink-3)", fontWeight: last ? 600 : 500 }, children: it.label }),
    !last && /* @__PURE__ */ jsx2(I.ChevRight, { size: 12, style: { color: "var(--pl-ink-4)" } })
  ] }, i);
}) }) });
var PLPagination = ({ page = 1, total, onChange }) => {
  ...
  for (const p of sorted) {
    if (p - prev > 1) buttons.push(/* @__PURE__ */ jsx2("span", { style: { color: "var(--pl-ink-4)", padding: "0 4px" }, children: "\u2026" }, `g${p}`));
    pushBtn(p);
    prev = p;
  }
  return /* @__PURE__ */ jsxs2("nav", { "aria-label": "Pagination", style: { display: "inline-flex", alignItems: "center", gap: 4 }, children: [
    /* @__PURE__ */ jsx2(
      "button",
      {
        type: "button",
        ...
        children: /* @__PURE__ */ jsx2(I.ChevLeft, { size: 14 })
      }
    ),
    buttons,
    /* @__PURE__ */ jsx2(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx2(I.ChevRight, { size: 14 })
      }
    )
  ] });
};
var PLTooltip = ({ label, side = "top", children }) => {
  ...
  return /* @__PURE__ */ jsxs2("span", { style: { position: "relative", display: "inline-flex" }, className: "pl-tooltip-host", children: [
    cloned,
    /* @__PURE__ */ jsx2(
      "span",
      {
    ...
    /* @__PURE__ */ jsx2("style", { children: `.pl-tooltip-host:hover [role="tooltip"], .pl-tooltip-host:focus-within [role="tooltip"] { opacity: 1 !important; }` })
  ] });
};
var PLMenu = ({ trigger, items, align = "left", onSelect }) => {
  ...
  return /* @__PURE__ */ jsxs2("span", { style: { position: "relative", display: "inline-flex" }, children: [
    /* @__PURE__ */ jsx2("span", { ref: triggerWrapRef, style: { display: "inline-flex" }, children: triggerEl }),
    open && /* @__PURE__ */ jsx2("div", { ref, role: "menu", style: {
      position: "absolute",
      top: "calc(100% + 6px)",
    ...
    }, children: items.map((it, i) => it.divider ? /* @__PURE__ */ jsx2("div", { role: "separator", style: { height: 1, background: "var(--pl-hairline)", margin: "4px 0" } }, `d${i}`) : /* @__PURE__ */ jsxs2(
      "button",
      {
        type: "button",
        role: "menuitem",
        ...
        children: [
          ...
          /* @__PURE__ */ jsx2("span", { style: { flex: 1 }, children: it.label }),
          it.shortcut && /* @__PURE__ */ jsx2("span", { className: "pl-mono", style: { fontSize: 10.5, color: "var(--pl-ink-4)" }, children: it.shortcut })
        ]
      },
      it.value || i
    )) })
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs2(
        "div",
        {
          ...
          children: [
            (title || onClose) && /* @__PURE__ */ jsxs2("div", { style: {
              display: "flex",
              ...
              /* @__PURE__ */ jsxs2("div", { style: { flex: 1 }, children: [
                title && /* @__PURE__ */ jsx2("div", { id: labelId, className: "pl-serif", style: { fontSize: 20, color: "var(--pl-ink-1)" }, children: title }),
                description && /* @__PURE__ */ jsx2("div", { id: descId, style: { fontSize: 12.5, color: "var(--pl-ink-3)", marginTop: 2 }, children: description })
              ] }),
              onClose && /* @__PURE__ */ jsx2(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsx2(I.X, { size: 16 })
                }
              )
            ] }),
            /* @__PURE__ */ jsx2("div", { style: { padding: 20, overflow: "auto", color: "var(--pl-ink-2)", fontSize: 13.5, lineHeight: 1.55 }, children }),
            footer && /* @__PURE__ */ jsx2("div", { style: {
              display: "flex",
